				...
				<ul class="nav navbar-nav side-nav">
					...
					if ((array_key_exists('webinterface_fresh_installation', $cfg) && $cfg['webinterface_fresh_installation'] != 1) || !array_key_exists('webinterface_fresh_installation', $cfg)) {
						...
						<li>
							...
							<?PHP echo '<ul id="addons" class="'.(in_array(basename($_SERVER['SCRIPT_NAME']), array("addon_assign_groups.php", "api.php", "addon_channelinfo_toplist.php", "addon_winner_toplist.php")) ? 'in collapse">' : 'collapse">'); ?>
								...
								<?PHP echo '<li'.(basename($_SERVER['SCRIPT_NAME']) == "addon_winner_toplist.php" ? ' class="active">' : '>'); ?>
									<a href="addon_winner_toplist.php"><i class="fas fa-chess-queen fa-fw"></i><span class="item-margin"><?PHP echo $lang['addonwitopl']; ?></span></a>
								</li>
							</ul>
						</li>
						<?PHP
