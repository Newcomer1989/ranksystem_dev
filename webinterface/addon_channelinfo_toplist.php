	...
	<div class="modal fade bd-example-modal-lg" id="addonchdescdesc" tabindex="-1">
	  <div class="modal-dialog modal-lg">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
<?php 
echo $lang['addonchdescdesc'] . '<br><br>';

$rows = [
	[$lang['addonchdescdesc01'], '{$CLIENT_ACTIVE_TIME_ALL_XXX}'],
	[$lang['addonchdescdesc02'], '{$CLIENT_ACTIVE_TIME_LAST_MONTH_XXX}'],
	[$lang['addonchdescdesc03'], '{$CLIENT_ACTIVE_TIME_LAST_WEEK_XXX}'],
	[$lang['addonchdescdesc32'], '{$CLIENT_ACTIVE_TIME_LAST_DAY_XXX}'],
	[$lang['addonchdescdesc04'], '{$CLIENT_ONLINE_TIME_ALL_XXX}'],
	[$lang['addonchdescdesc05'], '{$CLIENT_ONLINE_TIME_LAST_MONTH_XXX}'],
	[$lang['addonchdescdesc06'], '{$CLIENT_ONLINE_TIME_LAST_WEEK_XXX}'],
	[$lang['addonchdescdesc33'], '{$CLIENT_ONLINE_TIME_LAST_DAY_XXX}'],
	[$lang['addonchdescdesc07'], '{$CLIENT_IDLE_TIME_ALL_XXX}'],
	[$lang['addonchdescdesc08'], '{$CLIENT_IDLE_TIME_LAST_MONTH_XXX}'],
	[$lang['addonchdescdesc09'], '{$CLIENT_IDLE_TIME_LAST_WEEK_XXX}'],
	[$lang['addonchdescdesc34'], '{$CLIENT_IDLE_TIME_LAST_DAY_XXX}'],
	['<br>', ''],
	[$lang['addonchdescdesc10'], '{$CLIENT_CURRENT_CHANNEL_ID_XXX}'],
	[$lang['addonchdescdesc11'], '{$CLIENT_CURRENT_CHANNEL_NAME_XXX}'],
	[$lang['addonchdescdesc12'], '{$CLIENT_CURRENT_RANK_GROUP_ICON_URL_XXX}'],
	[$lang['addonchdescdesc13'], '{$CLIENT_CURRENT_RANK_GROUP_ID_XXX}'],
	[$lang['addonchdescdesc14'], '{$CLIENT_CURRENT_RANK_GROUP_NAME_XXX}'],
	[$lang['addonchdescdesc15'], '{$CLIENT_LAST_RANKUP_TIMEXXX}'],
	[$lang['addonchdescdesc16'], '{$CLIENT_NEXT_RANKUP_TIME_XXX}'],
	[$lang['addonchdescdesc17'], '{$CLIENT_RANK_POSITION_XXX}'],
	['<br>', ''],
	[$lang['addonchdescdesc18'], '{$CLIENT_COUNTRY_XXX}'],
	[$lang['addonchdescdesc20'], '{$CLIENT_CREATED_XXX}'],
	[$lang['addonchdescdesc22'], '{$CLIENT_DATABASE_ID_XXX}'],
	[$lang['addonchdescdesc23'], '{$CLIENT_DESCRIPTION_XXX}'],
	[$lang['addonchdescdesc24'], '{$CLIENT_LAST_SEEN_XXX}'],
	[$lang['addonchdescdesc25'], '{$CLIENT_NICKNAME_XXX}'],
	[$lang['addonchdescdesc26'], '{$CLIENT_ONLINE_STATUS_XXX}'],
	[$lang['addonchdescdesc27'], '{$CLIENT_PLATFORM_XXX}'],
	[$lang['addonchdescdesc28'], '{$CLIENT_TOTAL_CONNECTIONS_XXX}'],
	[$lang['addonchdescdesc29'], '{$CLIENT_UNIQUE_IDENTIFIER_XXX}'],
	[$lang['addonchdescdesc30'], '{$CLIENT_VERSION_XXX}'],
	['<br>', ''],
	[$lang['addonchdescdesc31'], '{$LAST_UPDATE_TIME}'],
];

echo '
<div class="row">
	<div class="col-md-5"><b>' . $lang['addonchdescdesc00'] . '</b></div>
	<div class="col-md-7"><b>' . $lang['descr'] . '</b></div>
</div>
<br>';

foreach ($rows as [$description, $varName]) {
	echo '
	<div class="row">
		<div class="col-md-5">' . $varName . '</div>
		<div class="col-md-7">' . $description . '</div>
	</div>';
}

echo '<br><br>';
echo sprintf('<h4><b>%s</b></h4><br>', $lang['addonchdesc2desc00']);

echo sprintf('%s<br><br>', $lang['addonchdesc2desc01']);
echo sprintf('<pre>%s</pre><br><br>', "{if {\$CLIENT_ONLINE_STATUS_1} === 'Online'}
	[COLOR=GREEN](Online)[/COLOR]
{else}
	[COLOR=RED](Offline)[/COLOR]
{/if}");
echo sprintf('%s<br><br>', $lang['addonchdesc2desc02']);
echo sprintf('<pre>%s</pre><br><br>', '{$CLIENT_LAST_SEEN_1|date_format:"%d.%m.%Y %H:%M:%S"}');

echo sprintf('%s<br><br>', $lang['addonchdesc2desc03']);
echo sprintf('<pre>%s<br>%s<br>%s<br>%s<br>%s<br>%s<br>%s<br>%s<br>%s</pre><br><br>',
'{$CLIENT_ACTIVE_TIME_ALL_1}                                        -> Defaut format: "1d, 23h, 59m, 59s"',
'{$CLIENT_ACTIVE_TIME_ALL_1|duration_format:"%D"}                   -> days',
'{$CLIENT_ACTIVE_TIME_ALL_1|duration_format:"%H"}                   -> time in hours',
'{$CLIENT_ACTIVE_TIME_ALL_1|duration_format:"%M"}                   -> time in minutes',
'{$CLIENT_ACTIVE_TIME_ALL_1|duration_format:"%S"}                   -> time in seconds',
'{$CLIENT_ACTIVE_TIME_ALL_1|duration_format:"%h"}                   -> hours 0-23',
'{$CLIENT_ACTIVE_TIME_ALL_1|duration_format:"%m"}                   -> minutes 0-59',
'{$CLIENT_ACTIVE_TIME_ALL_1|duration_format:"%s"}                   -> seconds 0-59',
'{$CLIENT_ACTIVE_TIME_ALL_1|duration_format:"%Dd, %hh, %mm, %ss"}  -> Defaut format: "1d, 23h, 59m, 59s"'
);

echo sprintf('%s<br><br>', $lang['addonchdesc2desc04']);
echo sprintf('<pre>%s</pre><br><br>', '{$CLIENT_NICKNAME_1|upper}');

echo sprintf('%s<br><br>', $lang['addonchdesc2desc05']);
echo sprintf('<pre>%s</pre><br><br>', '{$CLIENT_VERSION_1|regex_replace:"/(.*)(\\[.*)/":"$1"}');

echo sprintf(
	'%s <a href="%2$s" target="_blank">%2$s</a><br>',
	$lang['addonchdesc2desc98'],
	'https://www.smarty.net/docs/en/language.modifiers.tpl'
);

echo sprintf(
	'%s <a href="%2$s" target="_blank">%2$s</a>',
	$lang['addonchdesc2desc99'],
	'https://www.smarty.net/docs/en/language.builtin.functions.tpl'
);
?>
		  </div>
		  <div class="modal-footer">
