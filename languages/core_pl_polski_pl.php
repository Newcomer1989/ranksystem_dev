...
$lang['sgrpadd']			= "Przyznano grupe serwerową %s (ID: %s) do użytkownika %s (unique Client-ID: %s; Client-database-ID %s).";
...
$lang['stag0003']			= "Wybierz grupy serwerów, które użytkownik może przypisać do siebie.";
...
$lang['stag0015']			= "Nie można było Cię znaleźć na serwerze TeamSpeak. Proszę %skliknij tutaj%s aby się zweryfikować.";
...
$lang['stnv0020']			= "Ta strona zawiera ogólne podsumowanie Twoich osobistych statystyk i aktywności na serwerze.";
$lang['stnv0021']			= "Informacje te są zbierane od początku istnienia Ranksystemu, nie są one zbierane od początku istnienia serwera TeamSpeak.";
$lang['stnv0022']			= "Ta strona otrzymuje swoje wartości z bazy danych. Wartości te mogą być więc nieco opóźnione.";
$lang['stnv0023']			= "Ilość czasu online dla wszystkich użytkowników na tydzień i na miesiąc będzie obliczana tylko co 15 minut. Wszystkie inne wartości powinny być prawie na żywo (maksymalnie z kilkusekundowym opóźnieniem).";
...
$lang['stri0004']			= "Kto stworzył Ranksystem?";
$lang['stri0005']			= "Kiedy Ranksystem został utworzony?";
...
$lang['stri0012']			= "Specjalne podziękowania dla:";
$lang['stri0013']			= "%s za rosyjskie tłumaczenie";
$lang['stri0014']			= "%s za styl do bootstrap'a";
$lang['stri0015']			= "%s za włoskie tłumaczenie";
$lang['stri0016']			= "%s za arabskie tłumaczenie";
$lang['stri0017']			= "%s za rumuńskie tłumaczenie";
$lang['stri0018']			= "%s za holenderskie tłumaczenie";
$lang['stri0019']			= "%s za francuskie tłumaczenie";
$lang['stri0020']			= "%s za portugalskie tłumaczenie";
$lang['stri0021']			= "%s za świetne wsparcie w GitHub i nasz publiczny serwer, dzielenie się swoimi pomysłami, wstępne testowanie wszystkiego i wiele więcej";
$lang['stri0022']			= "%s za dzielenie się swoimi pomysłami i wstępnymi testami";
$lang['stri0023']			= "Stabilny od: 18/04/2016.";
$lang['stri0024']			= "%s za czeskie tłumaczenie";
$lang['stri0025']			= "%s za polskie tłumaczenie";
$lang['stri0026']			= "%s za hiszpańskie tłumaczenie";
...
$lang['wiexregrpdesc']		= "Jeśli użytkownik jest wykluczony z Ranksystem, grupa serwera przypisana przez Ranksystem zostanie usunięta.<br><br> Grupa zostanie usunięta tylko z '".$lang['wiexres']."' z '".$lang['wiexres1']."'. W pozostałych trybach grupa serwera <u>nie zostanie</u> usunięta.<br><br> Ta funkcja jest relevantna tylko w połączeniu z '".$lang['wiexuid']."' lub '".$lang['wiexgrp']."' w połączeniu z '".$lang['wiexres1']."'";
...
$lang['wits3predesc']		= "Na serwerze TeamSpeak możesz porozumiewać się z botem Ranksystem za pośrednictwem czatu. Domyślnie polecenia bota są oznaczone wykrzyknikiem '!'. Prefiks jest używany do identyfikacji poleceń dla bota jako takich. <br><br> Ten prefiks można zastąpić dowolnym innym pożądanym prefiksem. Może to być konieczne, jeśli używane są inne boti z podobnymi poleceniami. <br><br> Na przykład domyślne polecenie bota wyglądałoby tak: <br><pre>!help</pre><br><br> Jeśli prefiks zostanie zastąpiony znakiem '#', polecenie wyglądać będzie następująco: <br><pre>#help</pre>";
