...
$lang['sttw0016']			= "seconds";$lang['sttw0016']			= "seconds";
...
$lang['wiexregrpdesc']		= "Dacă un utilizator este exclus din Ranksystem, grupul de server atribuit de Ranksystem va fi eliminat.<br><br> Grupul va fi eliminat doar cu '".$lang['wiexres']."' cu '".$lang['wiexres1']."'. În toate celelalte moduri, grupul de server <u>nu</u> va fi eliminat.<br><br> Această funcție este relevantă doar în combinație cu un '".$lang['wiexuid']."' sau un '".$lang['wiexgrp']."' în combinație cu '".$lang['wiexres1']."'";
...
$lang['wistyledesc']		= "Definiți un stil personalizat diferit pentru sistemul de ranguri.<br>Acest stil va fi utilizat pentru pagina de statistici și interfața web.<br><br>Plasați propriul stil în directorul 'style' într-un subdirector propriu.<br>Numele subdirectorului determină numele stilului.<br><br>Stilurile care încep cu 'TSN_' sunt furnizate de către sistemul de ranguri. Acestea vor fi actualizate prin actualizări viitoare.<br>Prin urmare, nu ar trebui să se facă modificări în acestea!<br>Cu toate acestea, acestea pot fi utilizate ca șabloane. Copiați stilul într-un director propriu pentru a face modificări.<br><br>Sunt necesare două fișiere CSS. Unul pentru pagina de statistici și unul pentru interfața web.<br>De asemenea, se poate include un JavaScript propriu. Acest lucru este opțional.<br><br>Convenția de nume pentru CSS:<br><pre>- Fix 'ST.css' pentru pagina de statistici (/stats/)<br>- Fix 'WI.css' pentru pagina de interfață web (/webinterface/)</pre><br><br>Convenția de nume pentru JavaScript:<br><pre>- Fix 'ST.js' pentru pagina de statistici (/stats/)<br>- Fix 'WI.js' pentru pagina de interfață web (/webinterface/)</pre><br><br>Dacă doriți să oferiți și altora stilul dvs., puteți trimite la următoarea adresă de e-mail:<br><br><pre>%s</pre><br>Vom furniza cu următoarea versiune!";
...
$lang['wits3predesc']		= "Pe serverul TeamSpeak poți comunica cu botul Ranksystem prin intermediul chat-ului. În mod implicit, comenzile botului sunt marcate cu un semn de exclamare '!'. Prefixul este folosit pentru a identifica comenzile pentru bot ca atare. <br><br> Acest prefix poate fi înlocuit cu orice alt prefix dorit. Acest lucru poate fi necesar dacă se utilizează alți boturi cu comenzi similare. <br><br> De exemplu, comanda pentru botul implicit ar arăta astfel: <br><pre>!help</pre><br><br> Dacă prefixul este înlocuit cu '#', comanda ar arăta astfel: <br><pre>#help</pre>";
$lang['wits3qnm']			= "Nume";
