...
$lang['delmark']			= "Marcador de borrado";
...
$lang['isntwicfg']			= "Can't save the database configuration! Please assign full rights on 'other/dbconfig.php' (Linux: chmod 740; Windows: 'full access') and try again after.";
...
$lang['wihladm40desc']		= "La eliminación no tiene ningún impacto en el servidor TeamSpeak. Si el usuario todavía existe en la base de datos de TS, esta función <u>no</u> lo eliminará allí.";
...
$lang['wihladm500']			= "Fusión de usuario";
$lang['wihladm500desc']		= "En caso de que un usuario pierda su identidad en TeamSpeak, el usuario se conectará con una nueva y perderá todo su tiempo en línea/activo acumulado.<br><br>Esta función le permite combinar dos usuarios de TeamSpeak. Todos los tiempos acumulados (tanto en línea como inactivos) serán transferidos del usuario fuente al usuario destino.";
$lang['wihladm501']			= "seleccionar usuario";
$lang['wihladm502']			= "FUENTE";
$lang['wihladm502desc']		= "Seleccione un usuario que actúe como fuente. Los tiempos de este usuario serán transferidos al usuario destino.";
$lang['wihladm503']			= "DESTINO";
$lang['wihladm503desc']		= "Seleccione un usuario que sirva como destino. El usuario destino recibirá todas las veces (además de las propias) del usuario fuente.";
$lang['wihladm504']			= "fusionar tiempo a";
$lang['wihladm505']			= "¿Realmente deseas transferir el tiempo en línea/inactivo?";
$lang['wihladm506']			= "El tiempo del usuario %s (UUID: %s; DBID: %s) se transferirá al usuario %s (UUID: %s; DBID: %s) en unos segundos (consulte el registro de Ranksystem)";
$lang['wihladm507']			= "mostrar usuario desde \"último en línea\"";
$lang['wihladm507desc']		= "Elija una fecha. Para una mejor visibilidad, solo se ofrecen para selecciones los usuarios que han sido vistos después de esta fecha.";
$lang['wihladm508desc']		= "Seleccione esta opción para eliminar el USUARIO-ORIGEN de la base de datos del sistema de clasificación. El usuario completo se eliminará posteriormente, incluida toda la información restante.";
