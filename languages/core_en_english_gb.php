...
$lang['delmark']			= "Deletion mark/indicator";
...
$lang['wihladm40desc']		= "The deletion doesn't effect the TeamSpeak server. If the user still exists in the TS database, it will <u>not</u> be deleted due this function.";
...
$lang['wihladm500']			= "Merge user";
$lang['wihladm500desc']		= "In case, a user lost their TeamSpeak identity, the user will connect with a new one and lose all of their accumulated online/active time.<br><br>This function allows you to merge two TeamSpeak users. All accumulated times (both online and idle) will be transfered from the source user to the target user.";
$lang['wihladm501']			= "select user";
$lang['wihladm502']			= "SOURCE";
$lang['wihladm502desc']		= "Select a user who serves as the source. The times of this user will be transfered to the target user.";
$lang['wihladm503']			= "TARGET";
$lang['wihladm503desc']		= "Select a user who serves as the target. The target user will receive all times (in addition to their own) of the source user.";
$lang['wihladm504']			= "merge time to";
$lang['wihladm505']			= "You really want to transfer the online/idle time?";
$lang['wihladm506']			= "Time of the user %s (UUID: %s; DBID: %s) will be transfered to the user %s (UUID: %s; DBID: %s) in a few seconds (have a look to the Ranksystem log)";
$lang['wihladm507']			= "show user since \"last online\"";
$lang['wihladm507desc']		= "Choose a date. For better overview, only users that have been seen after this date are offered for selections.";
$lang['wihladm508desc']		= "Select this option to remove the SOURCE-user from the ranking system database. The complete user will be deleted subsequently, including all remaining information.";
...
$lang['wishcolhadesc']		= "The TeamSpeak 3 server stores the IP address of each client. This, we need for the Ranksystem to bind the website user of the statistics page with the related TeamSpeak user.<br><br>With this function, you can activate an encrypting / hashing of the IP addresses of TeamSpeak users. When enabled, only the hashed value will be stored in the database, instead of storing it in plain text. This is needed in some cases of your privacy legal; especially required due to the EU-GDPR.<br><br><b>fast hashing (default):</b> IP addresses will be hashed. The salt is different for each Ranksystem instance, but the same for all users on the server. This makes it faster, but also weaker as the 'secure hashing'.<br><br><b>secure hashing:</b> IP addresses will be hashed. Each user will get his own salt, which makes it hard to decrypt the IP (=secure). This parameter is conforming with the EU-GDPR. Contra: This variation affects the performance, especially on bigger TeamSpeak servers, it will slow down the statistics page on first site load very much. Also, it increases the needed resources.<br><br><b>disable hashing:</b> If this function is disabled, the IP address of a user will be stored in plain text. This is the fastest option that requires the least resources.<br><br><br>In all variants, the IP addresses of users will only be stored as long as the user is connected to the TS3 server (less data collection - EU-GDPR).<br><br>The IP addresses of users will only be stored once a user connected to the TS3 server. On changing this function, the user needs to reconnect to the TS3 server to be able to get verified with the Ranksystem webpage.";
