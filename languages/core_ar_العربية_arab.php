...
$lang['addonchdesc2desc00'] = "Advanced Options";
$lang['addonchdesc2desc01'] = "It is also possible to set an <b>if condition</b> to show some text only, when the condition is true.";
$lang['addonchdesc2desc02'] = "You can also change the <b>date format</b> by setting a format definition at the end of a variable.";
$lang['addonchdesc2desc03'] = "It can be changed the <b>time format</b>";
$lang['addonchdesc2desc04'] = "<b>Uppercase</b> some text.";
$lang['addonchdesc2desc05'] = "It is also possible to replace values with complex <b>regular expressions.</b>";
$lang['addonchdesc2desc98'] = "All options to change a variable value, are documentated here:";
$lang['addonchdesc2desc99'] = "All possible functions are documentated here:";
...
$lang['addonchdescdesc32']	= "Collected active time in the last 24h.";
$lang['addonchdescdesc33']	= "Collected online time in the last 24h.";
$lang['addonchdescdesc34']	= "Collected idle time in the last 24h.";
...
$lang['addonwitopl']		= "Winners Toplist";
$lang['addonwitopldesc']	= "The 'Winners Toplist' feature selects the winner of the week and the winner of the month at a definable point in time.<br><br>The times are calculated based on the well-known 'Top users of the week' or 'of the month' list. The current winners are also displayed there.<br><br>The current winner can receive a server group. Depending on the mode, the server group can be withdrawn from former winners or retained.<br><br>The winner is determined live during the specified period. If the Ranksystem is not running at that time, the winner will be determined retrospectively. Accordingly, when the function is activated, a winner will be determined retrospectively for the previous period from the historical data. However, retrospective determination is always imprecise and becomes increasingly imprecise the further back in time the determination has to be made.";
$lang['addonchtoplzz001']	= "Day";
$lang['addonchtoplzz001d']	= "Determine a day of the week on which the winner of the week will be determined.";
$lang['addonchtoplzz002']	= "Time";
$lang['addonchtoplzz002d']	= "Determine a time at which the winner of the week will be determined.";
$lang['addonchtoplzz003d']	= "Determine a day of the week on which the winner of the month will be announced.";
$lang['addonchtoplzz004d']	= "Determine a time at which the winner of the month will be determined.";
$lang['addonchtoplzz005']	= "Mode";
$lang['addonchtoplzz005d']	= "A server group can be assigned to the winner. This can be set up individually in advance on TeamSpeak.<br><br>Set the mode to determine whether<br><br>
- <b>deaktiviert</b> - disables the function. No server group is assigned or revoked.<br>- <b>withdraw</b> - removes the server group of the previous winner as soon as a new winner is determined.<br>- <b>leave</b> - leaves the server group of the previous winners (from the past) unchanged, even if a new winner has been determined.";
$lang['addonchtoplzz0051']	= "withdraw";
$lang['addonchtoplzz0052']	= "leave";
$lang['addonchtoplzz006']	= "winner Week";
$lang['addonchtoplzz006d']	= "Specify a server group that the winner of the week will receive.";
$lang['addonchtoplzz007']	= "winner Month";
$lang['addonchtoplzz007d']	= "Specify a server group that the winner of the month will receive.";
$lang['addonchtoplzz101']	= "Winner of last week";
$lang['addonchtoplzz102']	= "determined on";
$lang['addonchtoplzz103']	= "Next draw in";
$lang['addonchtoplzz104']	= "End of scoring";
$lang['addonchtoplzz105']	= "Winner of last month";
$lang['asc']				= "ascending";
...
$lang['daymonday']			= "Monday";
$lang['daytuesday']			= "Tuesday";
$lang['daywednesday']		= "Wednesday";
$lang['daythursday']		= "Thursday";
$lang['dayfriday']			= "Friday";
$lang['daysaturday']		= "Saturday";
$lang['daysunday']			= "Sunday";
$lang['day']				= "<small>day</small> %d";
$lang['days']				= "<small>يوم</small> %d";
$lang['dbconerr']			= "فشل الدخول الى قاعدة بيانات قاعدة بيانات: ";
$lang['delmark']			= "رقم مسح";
...
$lang['wiexregrpdesc']		= "إذا تم إستبعاد المستخدم من Ranksystem، فسيتم إزالة المجموعة المخصصة للخادم من قبل Ranksystem.<br><br> سيتم إزالة المجموعة فقط مع '".$lang['wiexres']."' مع '".$lang['wiexres1']."'. في جميع الوضعيات الأخرى، لن يتم إزالة المجموعة الخادم.<br><br> هذه الوظيفة مهمة فقط في الجمع مع '".$lang['wiexuid']."' أو '".$lang['wiexgrp']."' مع '".$lang['wiexres1']."'";
...
$lang['wihladm40desc']		= "لا يؤثر الحذف على خادم TeamSpeak. إذا كان المستخدم ما زال موجودًا في قاعدة بيانات TS ، فلن يتم حذفه من خلال هذه الوظيفة <u> لا </u>.";
...
$lang['wihladm500']			= "دمج المستخدم";
$lang['wihladm500desc']		= "في حالة عدم العثور على هوية المستخدم على تيم سبيك، سيتصل المستخدم بهوية جديدة وسيخسر كل الزمن الذي كان يتجمع بين حالات التواجد الإنترنت والخمول.<br><br>تتيح لك هذه الوظيفة دمج عضوين على تيم سبيك. سيتم نقل جميع الزمنات المتجمعة (حالات التواجد الإنترنت والخمول) من المستخدم المصدر إلى المستخدم الهدف.";
$lang['wihladm501']			= "اختيار المستخدم";
$lang['wihladm502']			= "المصدر";
$lang['wihladm502desc']		= "اختر مستخدمًا يخدم كمصدر. سيتم نقل الزمنات لهذا المستخدم إلى المستخدم الهدف.";
$lang['wihladm503']			= "الهدف";
$lang['wihladm503desc']		= "اختر مستخدمًا يخدم على عنوان الهدف. المستخدم الهدف سيتلقى جميع الأوقات (بالإضافة إلى أوقاته الخاصة) من المستخدم المصدر.";
$lang['wihladm504']			= "دمج الوقت إلى";
$lang['wihladm505']			= "هل ترغب حقًا في نقل وقت الإنترنت / الخمول؟";
$lang['wihladm506']			= "سيتم نقل الوقت الخاص بالمستخدم %s (UUID: %s؛ DBID: %s) إلى المستخدم %s (UUID: %s؛ DBID: %s) بعد بضع ثوان (انظر إلى سجل Ranksystem)";
$lang['wihladm507']			= "عرض المستخدم منذ \"آخر على الإنترنت\"";
$lang['wihladm507desc']		= "اختر تاريخًا. للحصول على عرض أفضل، تتوفر فقط المستخدمون الذين تم رؤيتهم بعد هذا التاريخ للاختيار.";
$lang['wihladm508desc']		= "اختر هذا الخيار لحذف مستخدم المصدر من قاعدة بيانات نظام الترتيب. سيتم حذف المستخدم الكامل بما في ذلك جميع المعلومات المتبقية.";
...
$lang['wistyledesc']		= "تعريف نمط مخصص (Style) لنظام الرتبة الذي يختلف عن النظام الإفتراضي.<br>سيتم استخدام هذا النمط لصفحة الإحصائيات وواجهة الويب.<br><br>ضع النمط الخاص بك في الدليل 'style' في الدليل الفرعي الخاص بك.<br>يحدد اسم الدليل الفرعي اسم النمط.<br><br>لذلك فلا ينبغي القيام بتعديلات في الأنماط التي تبدأ ب \"TSN_\". يمكن استخدامها كنموذج، لذلك يمكن نسخ الطراز في مجلد يدير تعديلاته.<br><br>يتطلب إنشاء ملفي CSS للصفحة الإحصائية والواجهة الشبكية. يمكن أيضًا تضمين جافا سكريبت خاص، الذي<br> يعد ذلك اختياريًا. <br> <br> تعريف تسمية الشكل الخارجي للصفحة الإحصائية والواجهة الشبكية: <br> <pre> - ثابت 'ST.css' للصفحة الإحصائية (/stats/) <br> - ثابت 'WI.css' للصفحة الشبكية الخارجية (/webinterface/) </pre> <br> <br> تعريف تسمية الجافا سكريبت للصفحة الإحصائية والواجهة الشبكية:<br><pre>- ثابت 'ST.js' للصفحة الإحصائية (/stats/)<br>- ثابت 'WI.js' للصفحة الشبكية الخارجية (/webinterface/)</pre><br><br>إذا كنت ترغب في مشاركة الطراز الخاص بك مع الآخرين، يمكنك إرساله إلى العنوان الإلكتروني التالي:<br><br><pre>%s</pre><br>سنصدرها في الإصدار التالي!";
...
$lang['wits3predesc']		= "على خادم TeamSpeak يمكنك التواصل مع بوت Ranksystem من خلال الدردشة. بشكل افتراضي، يتم وضع علامة '!' في أمام أوامر البوت كعلامة معرفة. يتم استخدام البريفيكس لتعريف الأوامر الخاصة بالبوت كما هو. <br><br> يمكن استبدال هذا البريفيكس بأي بريفيكس آخر مرغوب فيه. قد تكون هذه الخطوة ضرورية إذا كانت هناك بوتات أخرى تستخدم أوامر مماثلة. <br><br>على سبيل المثال، ستبدو الأمر الإفتراضي للبوت كما يلي:<br><pre>!help</pre><br><br>إذا قمت باستبدال البريفيكس ب '#'، فستبدو الأمر كما يلي:<br><pre>#help</pre>";
