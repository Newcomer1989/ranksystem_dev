...
$lang['addonwitopldesc']	= "The 'Winners Toplist' feature selects the winner of the week and the winner of the month at a definable point in time.<br><br>The times are calculated based on the well-known 'Top users of the week' or 'of the month' list. The current winners are also displayed there.<br><br>The current winner can receive a server group. Depending on the mode, the server group can be withdrawn from former winners or retained.";
